...
export const getGenres = () => async (dispatch: RandomizerDispatch) => {
  ...
  dispatch({ type: GET_GENRES, payload: { tv, movie } });
};

export const getTitle: GetTitle = (mediaType, genres) => async (
